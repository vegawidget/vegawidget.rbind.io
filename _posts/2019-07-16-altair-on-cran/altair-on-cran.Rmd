...
=======
The rendering functions themselves are re-exported from the [**vewgawidget**](https://vegawidget.github.io/vegawidget) package, which offers additional functions to provide interactivity using Shiny. We offer an online [example](https://ijlyttle.shinyapps.io/vegawidget-gapminder), and an [article](https://vegawidget.github.io/vegawidget/articles/articles/shiny.html).
>>>>>>> master
...
- [Jake Vanderplas](https://github.com/jakevdp), for his development of Altair and his support for this wrapping-package.
